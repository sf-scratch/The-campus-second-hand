...
//value hashmap序列化
    ...
    @Bean
    public RedisTemplate<String, User> redisTemplateUser(RedisConnectionFactory redisConnectionFactory) {
    ...
    @Bean
    public RedisTemplate<String, Admin> redisTemplateAdmin(RedisConnectionFactory redisConnectionFactory) {
        RedisTemplate<String, Admin> template = new RedisTemplate<>();
        RedisSerializer<String> redisSerializer = new StringRedisSerializer();
