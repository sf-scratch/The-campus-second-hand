  ...
  <div class="myPage">
    <div class="hbl-fa">
      <div class="comm">
        ...
        <div class="com-rep com-title">回复我的<span class="com-span">({{commentNum}})</span></div>
      </div>

      <div v-for="(item) in commentList" class="hbl-child">
        <div class="reply"></div>
        <el-row>
          <el-col :span="19"><div class="content">
            <div class="comment-f">
            ...
            <el-container>
              <el-main>
                <div class="parentContent">
                  {{checkContentLength(item.parentContent)}}
                </div></el-main>
            </el-container>
          </el-col>
          <el-col :span="2">
  ...
  import {reqReplyComment} from '@/api'
    ...
    methods: { //事件处理器
      ...
      async getReplyMessage(){
        let result = await this.$store.dispatch('getReplyMessage')
