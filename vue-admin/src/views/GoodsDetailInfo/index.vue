            ...
            <div class="priceArea">
              ...
              <div class="priceArea2">
                ...
                <div class="fixWidth">
                  <el-row>
                    <el-col :span="6">
                      <a href="javascript:0;" class="red-bg">QQ</a>
                      <em class="t-gray">{{goodsDetailInfo.contactQq}}</em>
                    </el-col>
                    <el-col :span="6">
                      <a href="javascript:0;" class="red-bg">微信</a>
                      <em class="t-gray">{{goodsDetailInfo.contactWx}}</em>
                    </el-col>
